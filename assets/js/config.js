...
const WEAPONS = {
    ...
    CIWS: { name: 'Phalanx CIWS', type: 'GUN', damage: 5, cooldown: 42, speed: 18, range: 145, targets: ['air','heli', 'cruise', 'munition'], icon: '🛡️', navalOmni: true, salvoCount: 4, salvoDelay: 1, leadMultiplier: 1.35, burstShots: 150, burstInterval: 2, spread: 0.15, interceptsMunitions: true },
