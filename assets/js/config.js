...
const WEAPONS = {
    ...
    AMRAAM: { name: 'AIM-120', type: 'AAM_HEAVY', damage: 45, cooldown: 90, speed: 5, range: 350, turn: 0.09, targets: ['air', 'heli', 'cruise', 'munition'], guidance: 'radar', ammo: 1, icon: '🚀+', navalOmni: true, salvoCount: 2, salvoDelay: 6 },
    LRAAM: { name: 'AIM-174B', type: 'AAM_HEAVY', damage: 65, cooldown: 130, speed: 6, range: 520, turn: 0.08, targets: ['air', 'heli', 'cruise', 'munition'], guidance: 'radar', ammo: 1, icon: '🛰️🚀', navalOmni: true, salvoCount: 2, salvoDelay: 8 },
